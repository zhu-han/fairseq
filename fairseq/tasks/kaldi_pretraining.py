...
@dataclass
class KaldiPretrainingConfig(FairseqDataclass):
...
@register_task("kaldi_pretraining", dataclass=KaldiPretrainingConfig)
class KaldiPretrainingTask(FairseqTask):
    """ """

    cfg: KaldiPretrainingConfig
    ...
    @classmethod
    def setup_task(cls, cfg: KaldiPretrainingConfig, **kwargs):
        """Setup the task (e.g., load dictionaries).

        Args:
            cfg (KaldiPretrainingConfig): configuration of this task
        """
    ...
    def load_dataset(self, split: str, task_cfg: FairseqDataclass = None, **kwargs):
        ...
        scp_path = os.path.join(data_path, "{}.scp".format(split))
        len_path = os.path.join(data_path, "{}.len".format(split))
        self.datasets[split] = KaldiFeatDataset(
            sample_rate=task_cfg.get("sample_rate", self.cfg.sample_rate),
            feats_scp_path=scp_path,
            feats_len_path=len_path,
            feats_dim=task_cfg.get("feats_dim", self.cfg.feats_dim),
